...
; (function (Skeleton, $) {
	...
	var CLASS_LIST = "sk-select-list", CLASS_STATUS = "select-status", CLASS_ACTIVE = "opened", CLASS_TEXT = "selected-text", CLASS_FADEIN = "fadeInUp_SK";
